...
urlpatterns = patterns('',
    ...
    # register
    url(r_company + r'/manage/json/registers/get', list_registers, name='mobile_get_registers'),
    url(r_company + r'/manage/json/registers/add', mobile_add_register, name='mobile_add_register'),
    url(r_company + r'/manage/json/registers/edit', mobile_edit_register, name='mobile_edit_register'),
