...
function select_category(e){
	...
	$("#selection .category-select").hide();
	...
	window.items.focused_item = this_item;
	
	// get the item into view
	// parent().parent():
	//    first parent: category-wrap-outer (fixed width, contains buttons),
	//    second: category-wrap-inner (wrapper for scrolling)
