    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_absolute', models.DecimalField(null=True, verbose_name='Discount, absolute value, sum of all valid discounts on this item', max_digits=16, decimal_places=4, blank=True)),
        ...
        migrations.AddField(
            model_name='bill',
            name='contact',
            field=models.ForeignKey(to='pos.BillContact'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bill',
