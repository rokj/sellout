    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'Normal', max_length=20, verbose_name='Bill type', choices=[(b'Normal', 'Normal')])),
                ('note', models.CharField(max_length=1000, null=True, verbose_name='Notes', blank=True)),
                ('sub_total', models.DecimalField(null=True, verbose_name='Sub total', max_digits=16, decimal_places=4, blank=True)),
                ('discount', models.DecimalField(null=True, verbose_name='Discount on the whole bill (absolute or percent)', max_digits=16, decimal_places=4, blank=True)),
                ('discount_type', models.CharField(blank=True, max_length=16, null=True, verbose_name='Type of discount', choices=[(b'Percent', 'Percentage'), (b'Absolute', 'Absolute value')])),
                ('tax', models.DecimalField(null=True, verbose_name='Tax amount, absolute value, derived from products', max_digits=16, decimal_places=4, blank=True)),
                ('total', models.DecimalField(null=True, verbose_name='Total amount to be paid', max_digits=16, decimal_places=4, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(null=True, editable=False, blank=True)),
                ('data', models.TextField(verbose_name='Serialized Bill history')),
                ('bill', models.ForeignKey(to='pos.Bill')),
                ('created_by', models.ForeignKey(related_name=b'pos_billhistory_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name=b'pos_billhistory_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.DecimalField(verbose_name='Number of items left in stock', max_digits=16, decimal_places=4)),
                ('product_id', models.BigIntegerField()),
                ('quantity', models.DecimalField(verbose_name='Quantity', max_digits=16, decimal_places=4)),
                ('base_price', models.DecimalField(verbose_name='Base price', max_digits=16, decimal_places=4)),
                ('tax_percent', models.DecimalField(null=True, verbose_name="Tax in percent, copied from product's tax rate", max_digits=7, decimal_places=4, blank=True)),
                ('tax_absolute', models.DecimalField(verbose_name='Tax amount (absolute value)', max_digits=16, decimal_places=4)),
                ('discount_absolute', models.DecimalField(null=True, verbose_name='Discount, absolute value, sum of all valid discounts on this product', max_digits=16, decimal_places=4, blank=True)),
                ('single_total', models.DecimalField(verbose_name='Total price for a single item', max_digits=16, decimal_places=4)),
                ('total', models.DecimalField(verbose_name='Total price', max_digits=16, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'Percent', max_length=30, verbose_name='Discount type', choices=[(b'Percent', 'Percentage'), (b'Absolute', 'Absolute value')])),
                ('amount', models.DecimalField(verbose_name='Amount', max_digits=16, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(null=True, editable=False, blank=True)),
                ('type', models.CharField(default=b'Individual', max_length=20, verbose_name='Type of contact', choices=[(b'Individual', 'Individual'), (b'Company', 'Company')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(null=True, editable=False, blank=True)),
                ('unit_price', models.DecimalField(verbose_name='Price per unit, excluding tax', max_digits=16, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(null=True, editable=False, blank=True)),
                ('unit_price', models.DecimalField(verbose_name='Purchase price per unit, excluding tax', max_digits=16, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(null=True, editable=False, blank=True)),
                ('amount', models.DecimalField(verbose_name='Tax amount', max_digits=7, decimal_places=4)),
        ...
        migrations.AlterUniqueTogether(
            name='purchaseprice',
            unique_together=set([('product', 'unit_price', 'datetime_updated')]),
        ),
        migrations.AddField(
            model_name='product',
            name='discounts',
        ...
        migrations.AddField(
            model_name='bill',
            name='contact',
            field=models.ForeignKey(related_name=b'bill_recipient_company', blank=True, to='pos.Contact', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bill',
