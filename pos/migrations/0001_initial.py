    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(max_length=200, null=True, verbose_name='Street address', blank=True)),
        ...
        migrations.AddField(
            model_name='bill',
            name='payment',
            field=models.ForeignKey(blank=True, to='payment.BillPayment', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bill',
