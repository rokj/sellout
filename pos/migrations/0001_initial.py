    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(default=datetime.datetime.utcnow, editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(default=datetime.datetime.utcnow, null=True, editable=False, blank=True)),
                ('name', models.CharField(max_length=50, verbose_name='Name of the register')),
                ...
                ('location', models.TextField(max_length=120, null=True, verbose_name='Location of register', blank=True)),
                ('print_location', models.BooleanField(default=True, verbose_name='Print location of register')),
                ('user_id', models.IntegerField()),
                ('user_name', models.CharField(max_length=64)),
                ('serial_prefix', models.CharField(max_length=32, choices=[(b'yyyy-s', 'Year and serial, resets every year'), (b's', 'Serial only, never resets'), (b'yyyy-m-s', 'Year, month and serial, resets every month')])),
                ('serial_number', models.IntegerField(null=True, verbose_name="Bill number, unique over all company's bills with the same prefix")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_payer', models.CharField(default=b'no', max_length=3, verbose_name='Tax payer', choices=[(b'yes', 'Yes'), (b'no', 'No'), (b'eu', 'EU')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', models.CharField(max_length=200, null=True, verbose_name='Company name', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_billitem_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_billitem_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_billitemdiscount_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_billitemdiscount_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.TextField(max_length=120, null=True, verbose_name='Location of register', blank=True)),
                ('print_location', models.BooleanField(default=True, verbose_name='Print location of register')),
                ('created_by', models.ForeignKey(related_name='pos_billregister_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default=b'ffffff', max_length=6, verbose_name='Color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_company_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_company_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_contact_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_contact_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_discount_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_discount_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_date', models.DateField(null=True, verbose_name='Document date', blank=True)),
                ('entry_date', models.DateField(null=True, verbose_name='Entry date', blank=True)),
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_document_created_by', to=settings.AUTH_USER_MODEL)),
                ('supplier', models.ForeignKey(to='pos.Contact')),
                ('updated_by', models.ForeignKey(related_name='pos_document_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_permission_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_permission_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_price_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_product_created_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='pos_productdiscount_created_by', to=settings.AUTH_USER_MODEL)),
                ('discount', models.ForeignKey(to='pos.Discount')),
                ('product', models.ForeignKey(to='pos.Product')),
                ('updated_by', models.ForeignKey(related_name='pos_productdiscount_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['seq_no'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.TextField(max_length=120, null=True, verbose_name='Location of register', blank=True)),
                ('print_location', models.BooleanField(default=True, verbose_name='Print location of register')),
                ('printer_driver', models.CharField(max_length=50, verbose_name='Printer', choices=[(b'System', 'Default system printer'), (b'Sellout', 'Sellout serial (must be installed)')])),
                ('device_id', models.CharField(max_length=128, null=True, verbose_name='Device id', blank=True)),
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_register_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_register_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(default=datetime.datetime.utcnow, editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(default=datetime.datetime.utcnow, null=True, editable=False, blank=True)),
                ('name', models.CharField(help_text='Name of a stock', max_length=100, null=True, verbose_name='Name', blank=True)),
                ('quantity', models.DecimalField(null=True, verbose_name='Number of items put in stock', max_digits=24, decimal_places=8, blank=True)),
                ('stock', models.DecimalField(verbose_name='Stock', max_digits=24, decimal_places=8)),
                ('left_stock', models.DecimalField(verbose_name='Number of items left in stock', max_digits=24, decimal_places=8)),
                ('stock_type', models.CharField(default=b'item', max_length=10, verbose_name='Stock type', choices=[(b'item', 'Item'), (b'ingredient', 'Ingrediant')])),
                ('unit_type', models.CharField(default=b'Piece', max_length=15, verbose_name='Product unit type', choices=[(b'Piece', 'Piece'), (b'g', b'g'), (b'dag', b'dag'), (b'kg', b'kg'), (b't', b'ton'), (b'oz', b'oz'), (b'lb', b'lb'), (b'cm', b'cm'), (b'm', b'm'), (b'in', b'in'), (b'ft', b'ft'), (b'yd', b'yd'), (b'in^2', b'in\xc2\xb2'), (b'm^2', b'm\xc2\xb2'), (b'ft^2', b'ft\xc2\xb2'), (b'l', b'l'), (b'dl', b'dl'), (b'cl', b'cl'), (b'm^3', b'm\xc2\xb3'), (b'fl. oz.', b'fl. oz.'), (b'pint', b'pint'), (b'gal', b'gal'), (b'ft^3', b'ft\xc2\xb3'), (b'h', 'Hour'), (b'other', 'Other')])),
                ('purchase_price', models.DecimalField(null=True, verbose_name='Purchase price per unit, excluding tax', max_digits=24, decimal_places=8, blank=True)),
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_stock_created_by', to=settings.AUTH_USER_MODEL)),
                ('document', models.ForeignKey(blank=True, to='pos.Document', null=True)),
                ('updated_by', models.ForeignKey(related_name='pos_stock_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime_created', models.DateTimeField(default=datetime.datetime.utcnow, editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(default=datetime.datetime.utcnow, null=True, editable=False, blank=True)),
                ('deduction', models.DecimalField(null=True, verbose_name='Stock', max_digits=24, decimal_places=8, blank=True)),
                ('created_by', models.ForeignKey(related_name='pos_stockproduct_created_by', to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(to='pos.Product')),
                ('stock', models.ForeignKey(to='pos.Stock')),
                ('updated_by', models.ForeignKey(related_name='pos_stockproduct_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            name='StockUpdateHistory',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('datetime_created', models.DateTimeField(default=datetime.datetime.utcnow, editable=False, blank=True)),
                ('datetime_updated', models.DateTimeField(default=datetime.datetime.utcnow, null=True, editable=False, blank=True)),
                ('history_info', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(related_name='pos_stockupdatehistory_created_by', to=settings.AUTH_USER_MODEL)),
                ('stock', models.ForeignKey(to='pos.Stock')),
                ('updated_by', models.ForeignKey(related_name='pos_stockupdatehistory_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(to='pos.Company')),
                ('created_by', models.ForeignKey(related_name='pos_tax_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name='pos_tax_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='stockproduct',
            unique_together=set([('stock', 'product')]),
        ),
        migrations.AddField(
            model_name='product',
            name='discounts',
        ...
        migrations.AddField(
            model_name='product',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_product_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='price',
        ...
        migrations.AddField(
            model_name='price',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_price_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='discount',
        ...
        migrations.AddField(
            model_name='category',
            name='created_by',
            field=models.ForeignKey(related_name='pos_category_created_by', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='category',
        ...
        migrations.AddField(
            model_name='category',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_category_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='billregister',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_billregister_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='billcontact',
            name='created_by',
            field=models.ForeignKey(related_name='pos_billcontact_created_by', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='billcontact',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_billcontact_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='billcompany',
            name='created_by',
            field=models.ForeignKey(related_name='pos_billcompany_created_by', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='billcompany',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_billcompany_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bill',
        ...
        migrations.AddField(
            model_name='bill',
            name='created_by',
            field=models.ForeignKey(related_name='pos_bill_created_by', to=settings.AUTH_USER_MODEL),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bill',
        ...
        migrations.AddField(
            model_name='bill',
            name='updated_by',
            field=models.ForeignKey(related_name='pos_bill_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
    ]
