    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name=b'pos_billcontact_created_by', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(related_name=b'pos_billcontact_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(related_name=b'pos_billregister_updated_by', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='bill',
            name='contact',
            field=models.ForeignKey(default=-1, to='pos.BillContact'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='bill',
            name='register',
            field=models.ForeignKey(default=-1, to='pos.BillRegister'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='register',
            name='location',
            field=models.TextField(max_length=120, null=True, verbose_name='Location of this register', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='register',
            name='name',
            field=models.CharField(default='none', max_length=50, verbose_name='Name of cash register'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='register',
            name='print_location',
            field=models.BooleanField(default=True, verbose_name='Print location of register'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='register',
            name='print_logo',
            field=models.BooleanField(default=True, verbose_name='Print logo on thermal receipts'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='register',
            name='receipt_format',
            field=models.CharField(default='none', max_length=32, verbose_name='Receipt format', choices=[(b'Page', 'Full page (Letter/A4)'), (b'Thermal', 'Thermal (80mm)')]),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='register',
            name='receipt_type',
            field=models.CharField(default='none', max_length=32, verbose_name='Receipt type', choices=[(b'Print', 'Printed'), (b'E-mail', 'E-mail')]),
            preserve_default=False,
        ),
    ]
