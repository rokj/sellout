...
class ConfigForm(forms.Form):
    ...
    payment_paypal_address = forms.CharField(label=_('Paypal email address'), help_text=_("where funds will be sent to when using paypal payment method"), max_length=34, required=False)
