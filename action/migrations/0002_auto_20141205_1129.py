...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='action',
            name='status',
            field=models.CharField(default=b'waiting', max_length=30, choices=[(b'accepted', 'Accepted'), (b'declined', 'Declined'), (b'waiting', 'Waiting'), (b'canceled', 'Canceled'), (b'seen', 'Seen')]),
            preserve_default=True,
        ),
    ]
