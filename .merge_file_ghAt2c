    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_total', models.DecimalField(null=True, verbose_name='Sub total', max_digits=24, decimal_places=8, blank=True)),
                ('discount', models.DecimalField(null=True, verbose_name='Discount on the whole bill (absolute or percent)', max_digits=24, decimal_places=8, blank=True)),
                ...
                ('tax', models.DecimalField(null=True, verbose_name='Tax amount, absolute value, derived from products', max_digits=24, decimal_places=8, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_price', models.DecimalField(verbose_name='Base price, without tax and discounts', max_digits=24, decimal_places=8)),
                ('tax_percent', models.DecimalField(null=True, verbose_name="Tax in percent, copied from product's tax rate", max_digits=11, decimal_places=8, blank=True)),
                ('tax_absolute', models.DecimalField(verbose_name='Tax amount, absolute value', max_digits=24, decimal_places=8)),
                ('discount_absolute', models.DecimalField(null=True, verbose_name='Discount, absolute value, sum of all valid discounts on this item', max_digits=24, decimal_places=8, blank=True)),
