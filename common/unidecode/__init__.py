...
# needed for custom modification, see comment below
import runpy
    ...
    for char in string:
        ...
        try:
            ...
            try:
                ...
                # modified for use without installing (using relative path):
                module_dir = __file__[:__file__.rfind('/')]
                data = runpy.run_path(module_dir+'/x%03x.py'%(section))['data']
            except ImportError:
                Cache[section] = None
                continue   # No match: ignore this character and carry on.

            Cache[section] = table = data
